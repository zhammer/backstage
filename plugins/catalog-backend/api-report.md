...
// Warning: (ae-missing-release-tag) "conditions" is exported by the package, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
...
export class NextCatalogBuilder {
  ...
  // Warning: (ae-forgotten-export) The symbol "CatalogPermissionRule" needs to be exported by the entry point index.d.ts
  //
  // (undocumented)
